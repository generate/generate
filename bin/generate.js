...
// generate.runner('generator.js', function(err, argv) {
//   if (err) handleError(err);

//   this.getGenerator('default')
//     .config.process(this.loadSettings(argv), function(err) {
//       if (err) handleError(err);

//       this.cli.process(argv, function(err) {
//         if (err) handleError(err);
//         generate.emit('done');
//         process.exit(0);
//       });
